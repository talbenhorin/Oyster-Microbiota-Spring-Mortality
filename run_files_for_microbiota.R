...
## Filtering sequences
pathF <- "forward" # CHANGE ME to the directory containing your demultiplexed forward-read fastqs
pathR <- "reverse" # CHANGE ME to the directory containing your demultiplexed reverse-read fastqs
...
# File parsing
filtpathF <- "forward/filtered" # CHANGE ME to the directory containing your filtered forward fastqs
...
## Save files
saveRDS(seqtab, "E:/tbenhor/libraries/Documents/Oyster-Microbiota-Spring-Mortality/output/seqtab.rds") 
saveRDS(tax, "E:/tbenhor/libraries/Documents/Oyster-Microbiota-Spring-Mortality/output/taxtab.rds") 
